...
ARTIFACT_SPECS: Mapping[str, ArtifactSpec] = MappingProxyType({
    ...
    "scene-prose": ArtifactSpec(rf"scene-prose-{_COORDINATE_PATTERNS['scene']}-{_COUNTER}", "scenes", "scene_prose.v{volume}.c{chapter}.s{scene}"),
    ...
    "scene": ArtifactSpec(rf"scene-{_COORDINATE_PATTERNS['scene']}-{_COUNTER}", "scenes", "scene.v{volume}.c{chapter}.s{scene}"),

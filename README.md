...
| [context contracts](docs/design/context_contracts.md) | Context投影と秘密除外 |
| [runtime and recovery](docs/design/runtime_and_recovery.md) | resume・commit・lock |
| [configuration contracts](docs/design/configuration_contracts.md) | 設定・timeout・budget |
| [implementation acceptance](docs/design/implementation_acceptance.md) | 次期実装の受入試験 |

...
初期設計は、作品の核、人物、関係、世界、知識、未解決事項、結末を整合させ、結末で解決が必須の未解決事項を、安定した識別子と満たすべき内容で明示して、最初の作品状態として確定します。シリーズ計画は各巻の位置と役割に加え、各必須事項をどの巻・章・場面で進め、どこで解決する予定かを持ちます。巻・章・場面の計画は、その計画対象で扱う必須事項 ID と、進行または解決に必要な条件を明示し、前段の計画と矛盾してはなりません。巻計画は第一巻ではシリーズ計画の確定後、第二巻以降では直前の巻が公開済みになった後にだけ作ります。

...
初期設計は、作品の核、人物、関係、世界、知識、未解決事項、結末を整合させ、結末で解決が必須の未解決事項を、安定した識別子と満たすべき内容で明示して、最初の作品状態として確定します。計画はシリーズ、巻、章、場面の順で作り、各計画は基準となる作品状態を明示します。シリーズ計画は各巻の位置と役割を定めますが、巻計画は第一巻ではシリーズ計画の確定後、第二巻以降では直前の巻が公開済みになった後にだけ作ります。
...
| 最終巻の結末必須事項の未達 | 初期設計の達成条件、現在の作品状態、根拠本文、独立した LLM 確認を照合する。参照または確定物の不整合は、上の整合性回復に従う。確定済み本文を望む結末のために作り直さず、未達を注意付き採用や公開で回避しない | 参照または確定物の不整合を是正できる場合は、その組から検証できる最も後の安全な工程。それ以外は人手確認待ちを維持する |
...
各巻は、その巻の全ての現行採用計画作業、場面本文、継続性更新が確定した後に、巻公開準備・確定を行います。ここでは、採用済みの巻を読者向け原稿へ決定的に組み立てられること、巻・章・場面の順序、公開注意、出力の完全性、作者用情報の除外を検証します。最終巻ではさらに、初期設計で結末に解決必須とした未解決事項が、現在の作品状態で漏れ・重複なく全件解決済みであり、各解決に対応する本文根拠が採用済みの確定済み本文に実在することを検証します。コードは対象集合、識別子、解決状態、重複、参照先、採用済み成果物との一致を決定的に検証し、独立した LLM 確認は、各根拠本文が初期設計の達成条件を実際に満たすかを確認します。この確認は最終巻の巻公開準備・確定の確認記録であり、別の要約・抽出成果物を作りません。満たせない場合は、注意付き採用では通過させず、巻公開を確定せずに `blocked` と停止理由 `manual_review_required` にします。これは最終巻の巻公開準備・確定の確認であり、別のシリーズ完結判定ではありません。次巻へ残す計画済みの問いや引きは、巻公開を妨げる未完ではありません。品質ループの修正上限で重大な指摘が残った巻は、編集上の注意を付けて公開します。形式不正、必須入力不足、公開注意種別の欠落・不正、または確定失敗なら巻公開を確定せず、`blocked` と停止理由 `manual_review_required` にして次巻の制作へ進みません。巻公開済みになってからだけ、次巻の計画へ進み、最終巻なら制作を完了します。

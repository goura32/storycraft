...
| シリーズ公開済み | 表示、検証 | 終了 |
| シリーズ公開不可終了 | 表示、検証、独立した巻別公開記録の解決・再判定・確定 | 終了。実行状態では `blocked` と停止理由 `completion_incomplete` で記録する。既に公開済みの巻は取り消さない |

この表はシリーズ全体の工程状態です。巻公開は、巻の引継ぎ後に作る独立した不変成果物であり、シリーズ全体の工程を完結判定準備完了や終了へ移しません。巻公開保留は巻別の公開記録であって、シリーズ全体の人手確認待ちには移しません。実行状態の停止値は `blocked` です。予算待ち、人手確認待ち、シリーズ公開不可終了は、ともに `blocked` と停止理由の組で表します。予算待ちの停止理由は `budget_exhausted`、人手確認待ちの停止理由は `manual_review_required`、シリーズ公開不可終了の停止理由は `completion_incomplete` です。品質上限に達した候補は人手確認待ちにします。これらは操作名ではなく停止状態です。再開 `resume`、作り直し `regenerate`、一工程実行 `step` は操作名であり、完結判定の結果とは別です。
...
品質判断待ちでは、未採用候補を破棄できます。ここでいう候補は、未採用の LLM 生成物または要約であり、決定的な巻公開判定やシリーズ完結判定の記録ではありません。候補の前提が有効なままなら、破棄後は新しい候補を作らず、その候補に関する工程を自動進行しません。修正・確認の上限は解決記録だけでは回復しません。候補の前提が実際に失効した場合だけ、最新の正本から新しい工程として作り直せます。その新しい工程には通常の上限を新たに適用します。整合性回復待ちでは、解決記録が相互に整合する不変成果物の組を一つ選び、以後の正本参照先にできます。整合する組を選べない場合はシリーズ公開不可終了とし、既存成果物を上書きして解決してはなりません。
...
各巻は、その巻の全ての現行採用計画作業、場面本文、継続性更新、巻の引継ぎが確定し、未解決の重大な指摘がなく、読者向け出力の安全性を確認できたときに巻公開判定を行います。次巻へ残す計画済みの問いや引きは、巻公開を妨げる未完ではありません。巻公開判定の結果は、公開可、注意付き公開可、公開保留です。公開保留は、その巻の公開記録にだけ保存する人手確認対象であり、シリーズ全体の人手確認待ちには移しません。運用責任者は原因、対象、根拠、結論を持つ不変の解決記録をその巻の公開記録へ確定します。解決後は、その記録に基づき、同じ確定済み入力だけで巻公開判定を再実行するか、公開しない記録を確定します。確定済み成果物を品質探索のために作り直してはなりません。巻公開が保留でも、正本と巻の引継ぎが整合していれば、次巻の制作は続けられます。
...
全巻が完了し、必要な未解決事項、結末、物語全体の流れを根拠とともに評価できるときだけ、シリーズ完結判定を実行します。計画版を切り替えるときは、それまでに確定した各場面を新版の対応する作業として必ず参照します。確定済み場面を対応先なしに新版から外してはなりません。必須確認は、全ての現行採用計画版の作業が確定済みであること、現行計画版が確定済み場面を全て参照すること、必須の未解決事項・結末・物語全体の流れごとに根拠参照付きの結論があること、未解決の重大な指摘がないことです。確認できない必須項目があれば未完です。
...
注意付きの巻公開またはシリーズ完結公開には、公開注意種別を必ず一つ保存します。公開注意種別は「表現」または「編集」だけです。公開上の注意として、それぞれ「表現上の注意があります。」「編集上の注意があります。」を必ず本文冒頭に出力します。注意なしの公開には公開注意種別を保存せず、公開上の注意も出力しません。種別が欠落・不正なら、巻公開ではその巻を公開保留にし、シリーズ完結公開ではシリーズ全体を人手確認待ちにします。内部の指摘番号、根拠位置、未開示事項、作者用の分析、内部要約は出力してはなりません。コードは許可された定型文以外が含まれる公開用原稿を拒否します。シリーズ完結判定が未完ではシリーズ公開用原稿を作成できず、V1 に手動例外はありません。

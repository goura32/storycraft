...
`initial_design` は、作品の構造と意図を一つの候補として生成、確認する工程です。重大な指摘があり、`quality_revision_limit` の上限前であれば候補全体を修正して再確認し、その後に採用します。人物だけ、世界だけ、結末だけを別工程で確定しません。人物変更後に古い人物像を前提とした関係・設定・結末を残さないためです。

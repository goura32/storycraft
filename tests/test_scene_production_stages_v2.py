...
class SceneProductionStagesV2Tests(unittest.TestCase):
    def _workspace(self, root: Path) -> None:
        ...
        write_json(root / "inputs/request-000001/record.json", {"schema_version": 1, "artifact_id": "request-000001", "artifact_kind": "request", "input_selection_id": None, "created_at": NOW, "content": {"title": "題", "genre": "fantasy", "premise": "前提", "required_elements": [], "forbidden_elements": [], "ending_preference": "希望", "volume_count": 4, "language": "ja"}})
        write_json(root / "runtime/settings/settings-000001/record.json", {"schema_version": 1, "settings_id": "settings-000001", "payload": {"endpoint": "injected", "model": "test", "quality_revision_limit": 0, "invalid_response_limit": 5, "scene_text_char_range": [1, 100]}, "created_at": NOW})

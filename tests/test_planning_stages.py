...
class Model:
    ...
    def generate(self, stage: str, context: dict[str, Any]) -> dict[str, Any]:
        ...
        payloads = {
            ...
            "volume-plan": {"title": "巻", "volume_purpose": "目的", "central_conflict": "対立", "character_changes": {"char-main": "変化"}, "relationship_changes": {"rel-main": "変化"}, "thread_goals": {"塔の試練": "進展"}, "revelations": [], "chapter_summaries": [{"chapter_number": 1, "purpose": "章"}], "required_end_state": "終了"},

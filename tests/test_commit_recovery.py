...
def populate_scene_commit_staging(root: Path) -> None:
    ...
    write_record(root, f"{staging}/gen-000002", {"schema_version": 1, "artifact_id": "gen-000002", "artifact_kind": "generation", "input_selection_id": "selection-999999", "created_at": NOW, "content": {"story_facts": [{"fact_id": "fact-000001", "value": "更新"}], "character_knowledge": {"char-main": []}, "reader_disclosures": [], "unresolved_thread_states": {"塔の試練": {"status": "open"}}, "timeline_position": 1}})

...
def populate_scene_commit_staging(root: Path) -> None:
    ...
    write_record(root, "generations/gen-000001", {"schema_version": 1, "artifact_id": "gen-000001", "artifact_kind": "generation", "input_selection_id": "selection-666666", "created_at": NOW, "content": {"story_facts": [{"fact_id": "fact-000001", "value": "開始"}], "character_knowledge": {"char-main": []}, "reader_disclosures": [], "unresolved_thread_states": {"塔の試練": {"status": "open"}}, "timeline_position": 0}})
    ...
    write_record(root, "design/volume-plans/volume-plan-v01-000001", {"schema_version": 1, "artifact_id": "volume-plan-v01-000001", "artifact_kind": "volume-plan", "input_selection_id": "selection-777777", "created_at": NOW, "content": {"title": "第一巻", "volume_purpose": "目的", "central_conflict": "対立", "character_changes": {"char-main": "変化"}, "relationship_changes": {"rel-main": "変化"}, "thread_goals": {"塔の試練": "進展"}, "revelations": [], "chapter_summaries": [{"chapter_number": 1, "purpose": "章1"}], "required_end_state": "次へ"}})
    ...
    staging = "runtime/staging/scene-commit-scene-commit-v01-c01-s01-000001"
    write_record(root, f"{staging}/scene-v01-c01-s01-000002", {"schema_version": 1, "artifact_id": "scene-v01-c01-s01-000002", "artifact_kind": "scene", "input_selection_id": "selection-000001", "created_at": NOW, "content": {"coordinate": {"volume_number": 1, "chapter_number": 1, "scene_number": 1}, "scene_prose_id": "scene-prose-v01-c01-s01-000001", "continuity_update_id": "continuity-v01-c01-s01-000001", "current_state_id": "gen-000001", "scene_card_id": "scene-card-v01-c01-s01-000001", "quality_disposition_id": "quality-000001"}})
    write_record(root, f"{staging}/gen-000002", {"schema_version": 1, "artifact_id": "gen-000002", "artifact_kind": "generation", "input_selection_id": "selection-000001", "created_at": NOW, "content": {"story_facts": [{"fact_id": "fact-000001", "value": "開始"}], "character_knowledge": {"char-main": []}, "reader_disclosures": [], "unresolved_thread_states": {"塔の試練": {"status": "open"}}, "timeline_position": 0}})
    ...
    write_record(root, "candidates/candidate-000001", {"schema_version": 1, "candidate_id": "candidate-000001", "artifact_kind": "scene-prose", "input_selection_id": "selection-000001", "keywords_id": None, "settings_id": "settings-000001", "payload": {"coordinate": {"volume_number": 1, "chapter_number": 1, "scene_number": 1}, "text": "本文"}, "parent_candidate_id": None, "review_record_id": None, "call_id": "call-000001", "created_at": NOW})
    write_record(root, "reviews/review-000001", {"schema_version": 1, "review_id": "review-000001", "candidate_id": "candidate-000001", "response": {"schema_version": "review-response-v1", "decision": "pass", "issues": []}, "call_id": "call-000002", "created_at": NOW})
    write_record(root, "candidates/candidate-000002", {"schema_version": 1, "candidate_id": "candidate-000002", "artifact_kind": "continuity-update", "input_selection_id": "selection-000001", "keywords_id": None, "settings_id": "settings-000001", "payload": {"coordinate": {"volume_number": 1, "chapter_number": 1, "scene_number": 1}, "changes": []}, "parent_candidate_id": None, "review_record_id": None, "call_id": "call-000001", "created_at": NOW})
    write_record(root, "reviews/review-000002", {"schema_version": 1, "review_id": "review-000002", "candidate_id": "candidate-000002", "response": {"schema_version": "review-response-v1", "decision": "pass", "issues": []}, "call_id": "call-000002", "created_at": NOW})
    write_record(root, "quality/quality-000002", {"schema_version": 1, "quality_id": "quality-000002", "candidate_id": "candidate-000002", "review_record_ids": ["review-000002"], "revision_count": 0, "result": "accepted", "remaining_major_issues": [], "created_at": NOW})
    for adoption_id, content_id, candidate_id, quality_id in (("adoption-000001", "scene-prose-v01-c01-s01-000001", "candidate-000001", "quality-000001"), ("adoption-000002", "continuity-v01-c01-s01-000001", "candidate-000002", "quality-000002")):
        write_record(root, f"runtime/adoptions/{adoption_id}", {"schema_version": 1, "adoption_id": adoption_id, "source_kind": "candidate", "candidate_id": candidate_id, "quality_id": quality_id, "output_content_artifact_ids": [content_id], "output_selection_id": "selection-000001", "input_selection_id": "selection-000001", "created_at": NOW})

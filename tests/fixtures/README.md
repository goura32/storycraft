...
- ハッシュ値や成果物の関係図は、最小資料の前提にしない。公開用資料は確定済み入力を前提とする。`catalog.json` に残る `handoff/summary.md`、`publication/*/series.md`、`completion/`、旧 run-state の資料は、旧契約の拒否・差分確認に使う試験データであり、現行公開経路の入力や製品契約ではない。
